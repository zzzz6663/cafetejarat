            ...
            <div class="col-12">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-12">
                            @include('home.error')
                            <form action="{{route('vcat.update',$vcat->id)}}" class="form-control" method="post"  enctype="multipart/form-data">
                                @csrf
                                @method('patch')
                            <div class="mb-3">
                                <label class="form-label">نام</label>
                                <input type="text" name="title" value="{{old('title',$vcat->title)}}" class="form-control" name="example-text-input" placeholder="نام دسته بندی  ">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="content" rows="6" placeholder="Content..">{{old('content',$vcat->title)}}</textarea>
                            </div>
                            <div class="mb-3">
