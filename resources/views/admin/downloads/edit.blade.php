            ...
            <div class="col-12">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-12">
                            @include('home.error')
                            <form autocomplete="off" action="{{route('download.update' ,$download->id)}}" class="form-control" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('patch')
                                <div class="mb-3">
                                    <label class="form-label">نام</label>
                                    <input type="text" name="title" value="{{old('title',$download->title)}}" class="form-control" name="example-text-input" placeholder="نام      ">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">توضیحات <span class="form-label-description"></span></label>
                                    <textarea class="form-control" name="content" rows="6" placeholder="Content..">{{old('content',$download->content)}}</textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <a class="btn btn-danger" href="{{$download->file()}}">دانلود فایل</a>
